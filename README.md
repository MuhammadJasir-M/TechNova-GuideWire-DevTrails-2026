...
> \*A zero-touch platform that automatically detects disruptions, verifies claims 
> with multi-signal fraud intelligence, and pays delivery workers before they 
> even realize they've lost income.\*
...
> \*"⚠️ High flood risk this week in your zone (78%). Your coverage: 
> ₹2,000. Premium: ₹59. Tap to renew."\*
...
> just drained a platform's liquidity pool. Simple GPS verification is dead.\*
...
checks: *"Was he in or near that zone in the 2 hours before the trigger fired?"*  
...
> \*"Your claim was verified with 94% confidence based on weather data, 
